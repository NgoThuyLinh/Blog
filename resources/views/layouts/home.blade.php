      ...
      <div class="content col-xs-8">
       ...
       <div class="content col-xs-6">
        ...
        <div class="content col-xs-6 clearfix">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-5.jpg') }}" alt="post image 5">
                    <div class="category"><a href="#">IMG</a></div>
                </div>
                <div class="post-text">
        ...
        <div class="content col-xs-6">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-6.jpg') }}" alt="post image 6">
                    <div class="category"><a href="#">Travel</a></div>
                </div>
                <div class="post-text">
        ...
        <div class="content col-xs-6 clearfix">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-7.jpg') }}" alt="post image 7">
                    <div class="category"><a href="#">Business</a></div>
                </div>
                <div class="post-text">
        ...
        <div class="content col-xs-6">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-8.jpg') }}" alt="post image 8">
                    <div class="category"><a href="#">Technology</a></div>
                </div>
                <div class="post-text">
                	<span class="date">01 Jun 2016</span>
        ...
        <div class="content col-xs-6 clearfix">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-9.jpg') }}" alt="post image 9">
                    <div class="category"><a href="#">Business</a></div>
                </div>
                <div class="post-text">
                	<span class="date">01 Jun 2016</span>
        ...
        <div class="content col-xs-6">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{ asset('blog_assets/img/img-post-10.jpg') }}" alt="post image 10">
                    <div class="category"><a href="#">Technology</a></div>
                </div>
                <div class="post-text">
                	<span class="date">01 Jun 2016</span>
