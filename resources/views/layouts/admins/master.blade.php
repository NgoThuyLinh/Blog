...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="dropdown-item btn btn-flat" href="{{ route('logout') }}" onclick="event.preventDefault();
...
<script type="text/javascript">
  var url_users='{{route('userlist')}}';
  var url_posts='{{route('postlist')}}';
  var url='{{asset('admin')}}';
  var url_categories='{{route('categorylist')}}';
    $.ajaxSetup({
      headers: {
